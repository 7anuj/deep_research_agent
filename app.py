...
if query := st.chat_input("Ask your legal question..."):
    ...
    try:
        ...
        result = {"answer": "⚠️ Could not generate an answer.", "source_documents": []}

    # Summarize strictly using Gemini
...
with st.expander("📂 Upload PDFs for context (optional)"):
    ...
    if uploaded_files:
        ...
        st.session_state.qa_chain, st.session_state.tracker = build_user_chain(user_paths)
